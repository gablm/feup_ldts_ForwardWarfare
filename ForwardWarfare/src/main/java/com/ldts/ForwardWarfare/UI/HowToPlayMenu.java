...
public class HowToPlayMenu extends UI{
    ...
    public void draw() throws IOException {
        ...
        graphics.putString(3, 19,                      "             The turns must be consecutive.");
        graphics.putString(new TerminalPosition(3, 20),"   ` Factories - You can Buy One Ground Unit Per Round." );
        graphics.putString(new TerminalPosition(3, 21),"   > Airports - You can Buy One Air Unit Per Round." );
        graphics.putString(new TerminalPosition(3, 22),"   ) Ports - You can Buy One Sea Unit Per Round." );
        graphics.putString(new TerminalPosition(3, 23),"   / OilPumps - Gives You Plus 10 Income Per Round." );
        graphics.setForegroundColor(TextColor.ANSI.RED_BRIGHT);
        graphics.enableModifiers(SGR.BOLD);
        graphics.putString(new TerminalPosition(3, 26),"                          MOVEMENT" );
        graphics.disableModifiers(SGR.BOLD);
        graphics.setForegroundColor(new TextColor.RGB(0,0,0));
        graphics.putString(new TerminalPosition(3, 28),"    ESC - Open the menu or goes back to the default section." );
        graphics.putString(new TerminalPosition(3, 29),"    ENTER - Confirms the action." );
        graphics.putString(new TerminalPosition(3, 30),"    ARROWS - Movement keys." );
        graphics.disableModifiers(SGR.BOLD);
        graphics.setForegroundColor(new TextColor.RGB(0,0,0));
        screen.refresh();
    }
